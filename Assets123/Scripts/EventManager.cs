...
public class EventManager : MonoBehaviour
{
    ...
    public Image EventTimerUpImage;
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            if (timer >= 3)
            {
                Event(typeX);
                timer = 0f;
                EventTimerUpImage.GetComponent<Image>().sprite = Square;
                EventTimerImage.fillAmount = 0f;
            }
    ...
    private int choseEvent()
    {
        ...
        EventTimerUpImage.GetComponent<Image>().sprite = images[type-1];
        switch (type)
        {
            case 1:
    ...
    {
        AudioManager.Instance.PlaySFX("FlashBang");
