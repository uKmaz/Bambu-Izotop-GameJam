...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        sceneTransitionManager = ScreenController.GetComponent<SceneTransitionManager>();
        ...
        if (gameObject.name.Contains("Player1"))
        {
            ...
            controls.PauseKey= InputManager.GetKey("Player1_Pause", controls.PauseKey);
        }
        else if (gameObject.name.Contains("Player2"))
        {
            ...
            controls.PauseKey = InputManager.GetKey("Player2_Pause", controls.PauseKey);
    ...
    private void PauseTheGame()
    {
        ...
        if (Input.GetKeyDown(controls.PauseKey)&&!gamePaused) {
            Time.timeScale = 0f;
            sceneTransitionManager.LoadPause();
            gamePaused = true;
            
        }
        else if(Input.GetKeyDown(controls.PauseKey)&&gamePaused)
        {
